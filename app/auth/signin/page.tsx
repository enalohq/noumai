  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        const errorMessage = result.error === "Configuration" || result.error === "CredentialsSignin"
    ...
    <div className="flex min-h-screen items-center justify-center bg-th-bg px-4 py-12">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          <h1 className="text-2xl font-bold text-th-text">Sign In</h1>
          <p className="mt-2 text-sm text-th-text-muted">
            Access your AEO Tracker dashboard
          </p>
        </div>
        ...
        <div className="rounded-xl border border-th-border bg-th-card p-6 shadow-sm">
          ...
          <div className="mt-6 text-center text-sm text-th-text-muted">
            ...
            <Link href="/auth/signup" className="font-medium text-th-text-accent hover:underline">
              Sign up
            </Link>
          </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-th-card px-2 text-th-text-muted">Or continue with</span>
              </div>
            </div>
