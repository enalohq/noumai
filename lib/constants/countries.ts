...
export const COUNTRIES: CountryOption[] = [
  ...
  { name: "Northern Cyprus", flag: "🇨🇾", aliases: ["CY-NC"], code: "CY-NC" },
  { name: "Transnistria", flag: "🇲🇩", aliases: ["MD-TR"], code: "MD-TR" },
  { name: "Somaliland", flag: "🇸🇴", aliases: ["SO-SL"], code: "SO-SL" },
  { name: "Artsakh", flag: "🇦🇿", aliases: ["AZ-NK"], code: "AZ-NK" },
];
